...
export function GameModeIcon({ icon, className }: { icon: string; className?: string }): React.ReactNode {
  const IconComponent = ICONS[icon] || ICONS.star;
  return IconComponent({ className });
}

export function ClockIcon({ className }: IconProps): React.ReactNode {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export function TrophyIcon({ className }: IconProps): React.ReactNode {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export function LightbulbIcon({ className }: IconProps): React.ReactNode {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export function SparkleIcon({ className }: IconProps): React.ReactNode {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export function RotateIcon({ className }: IconProps): React.ReactNode {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className}>
